...
const vehicleColors = [0xF0ECE3, 0xDFD3C3, 0xC7B198, 0xA68DAD];

const lawnGreen = "#C7B198";
const trackColor = "#546E90";
const edgeColor = "#DFD3C3";
const treeCrownColor = 0xA68DAD;
